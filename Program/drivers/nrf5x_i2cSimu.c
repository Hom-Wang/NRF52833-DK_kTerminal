 ...
 */
uint32_t SimuI2C_WriteRegs( SimuI2C_InitTypeDef *pSimuI2c, const uint8_t slaveAddr, const uint8_t regAddr, const uint8_t *regData, uint32_t lens )
{
    uint8_t address8bit = slaveAddr << 1;
#if 0
#if ENABLE_ACK_CHECK
 ...
 */
uint32_t SimuI2C_ReadRegs( SimuI2C_InitTypeDef *pSimuI2c, const uint8_t slaveAddr, const uint8_t regAddr, uint8_t *regData, uint32_t lens )
{
    uint8_t address8bit = slaveAddr << 1;
#if 0
#if ENABLE_ACK_CHECK
...
uint32_t SimuI2C_ScanRegs( SimuI2C_InitTypeDef *pSimuI2c, const uint8_t address, uint8_t *reg )
{
    uint8_t res[256];
    uint32_t status;
 ...
 */
uint32_t SimuI2C_ScanDeviceGPIO( const uint8_t sclpin, const uint8_t sdapin, uint8_t *address )
{
    uint8_t device;
 ...
 */
uint32_t SimuI2C_ScanRegsGPIO( const uint8_t sclpin, const uint8_t sdapin, const uint8_t address, uint8_t *reg )
{
    uint8_t status;
    SimuI2C_InitTypeDef i2c =
    {
